...
ALTER TABLE js_cms_article_data
	ADD FOREIGN KEY (id)
	REFERENCES js_cms_article (id)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;


ALTER TABLE js_cms_article_posid
...
ALTER TABLE js_cms_article_tag
	ADD FOREIGN KEY (article_id)
	REFERENCES js_cms_article (id)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
...
ALTER TABLE js_cms_article
	ADD FOREIGN KEY (category_code)
	REFERENCES js_cms_category (category_code)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;


ALTER TABLE js_cms_category_role
	ADD FOREIGN KEY (category_code)
	REFERENCES js_cms_category (category_code)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
...
ALTER TABLE js_cms_category
	ADD FOREIGN KEY (site_code)
	REFERENCES js_cms_site (site_code)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
...
ALTER TABLE js_cms_article_tag
	...
	REFERENCES js_cms_tag (tag_name)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
